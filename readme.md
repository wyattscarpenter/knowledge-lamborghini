...
* `enumerate responses (argument)` lists all the responses for the channel. If an argument is provided, it will only list responses associated with that argument.
